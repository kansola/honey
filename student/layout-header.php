<!DOCTYPE html> 
<html class="transition-navbar-scroll bottom-footer js flexbox flexboxlegacy canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface generatedcontent video audio localstorage sessionstorage webworkers applicationcache svg inlinesvg smil svgclippaths top-navbar-xlarge" lang="en">
<head>
    ...
    <script src="assets/js/infobox_packed.js"></script>
    <script src="assets/js/jquery.ui.map.rdfa.js"></script>
    <script src="assets/js/jquery.ui.map.overlays.js"></script>
    <script src="assets/js/jquery.ui.map.microformat.js"></script>
    <script src="assets/js/jquery.ui.map.microdata.js"></script>
    <script src="assets/js/jquery.ui.map.services.js"></script>
    <script src="assets/js/jquery.ui.map.extensions.js"></script>
    <script src="assets/js/jquery.ui.map.js"></script> -->
    

    <title>Oyin & Prince CS4 Project</title>
  
    <link href="assets/css/bootstrap.css" rel="stylesheet">
    <link href="assets/css/font-awesome.css" rel="stylesheet">

        
    <!-- <link href="assets/css/picto.css" rel="stylesheet"> -->
    <!-- <link href="assets/css/material-design-iconic-font.css" rel="stylesheet"> -->
    <!-- <link href="assets/css/datepicker3.css" rel="stylesheet"> -->
    <!-- <link href="assets/css/jquery.minicolors.css" rel="stylesheet"> -->
    <!-- <link href="assets/css/railscasts.css" rel="stylesheet"> -->
    ...
    <!-- <link href="assets/css/sidebar-skins.css" rel="stylesheet"> -->
    ...
    <link href="assets/css/colors-alerts.css" rel="stylesheet">
    <link href="assets/css/colors-background.css" rel="stylesheet">
    <!-- <link href="assets/css/colors-buttons.css" rel="stylesheet"> -->
    <!-- <link href="assets/css/colors-text.css" rel="stylesheet"> -->
...
<body cz-shortcut-listen="true" class="breakpoint-1024">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="main-nav">
            <ul class="nav navbar-nav navbar-nav-margin-left">
                ...
                <li class="dropdown">
                    <a href="index.php"> Dashboard</span></a>
                </li>

                <li class="dropdown">
                    <a href="courses.php"> My Courses</span></a>
                </li>
                ...
                <ul class="nav navbar-nav navbar-nav-bordered navbar-nav-margin-right">
                    ...
                    <li class="dropdown user">
                        <a href="profile.php#" class="dropdown-toggle" data-toggle="dropdown">
                            <!-- <img src="assets/images/guy-6.jpg" alt="" class="img-circle">  -->
                        <span class="caret"></span>
                        </a>
                        <ul class="dropdown-menu" role="menu">
                            <!--<li><a href="profile.php"><i class="fa fa-bar-chart-o"></i> Profile</a></li>-->
                            <li><a href="../logout.php"><i class="fa fa-bar-chart-o"></i> Logout</a></li>
                        </ul>
                    </li>
                    <!-- // END user -->
                </ul>
                <a href="../logout.php" class="navbar-btn btn btn-primary">Logout</a>
            </div>
        </div><!-- /.navbar-collapse -->
