                                            ...
                                            <div class="panel panel-default paper-shadow" data-z="0.5">
                                                <div class="panel-body">
                                                    ...
                                                    <p class="text-light text-caption">
                                                     <i class="fa fa-clock-o fa-fw"></i>Test deadline  
                                                     <span class="pull-right">
                                                       <span style='font-weight:bold'>Marks Obtained</span><br/>
                                                       
                                                           
                                                            
                                                     </span>
                                                    </p>
                                                    <p class="text-light">Maximum of  minutes</p>
                                                        ...
                                                        <span class="label label-success">SUBMITTED ALREADY</span>  
                                                            ...
                                                            <a href="course_quiz_questions.php?test_id=">Start Test</a>
