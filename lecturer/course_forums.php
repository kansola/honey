                                    ...
                                    <div class="col-md-12">    
                                        ...
                                        <div id="myTabContent" class="tab-content">
                                            ...
                                            <div class="tab-pane fade in active">
                                                ...
                                                <p><button class="btn btn-danger" data-toggle="modal" data-target="#modal-responsive"><i class="fa fa-plus"></i> Ask Question</button></p>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <form method="post" class="form-horizontal">
                                                                    ...
                                                                    <label>DETAILS</label> 
                                                                    <textarea name="detail" class="form-control valid" parsley-minwords="3" required></textarea>
